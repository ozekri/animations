...
\begin{tikzpicture}[->, auto, thick, node distance=4cm, >=latex] 
    ...
    \path[->, very thick, >=latex, draw=black] 
        (0) edge [loop left, distance=1cm, out=200, in=225] node[arrow label, left] {0.60} (0)
            edge [bend left=20] node[arrow label, left] {0.20} (1)
            edge [bend left=15] node[arrow label, above] {0.20} (2)
