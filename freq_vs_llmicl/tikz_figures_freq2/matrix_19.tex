...
\begin{tikzpicture}[->, auto, thick, node distance=4cm, >=latex] 
    ...
    \path[->, very thick, >=latex, draw=black] 
        ...
        (2) edge [loop right, distance=1cm, out=-50, in=-25] node[arrow label, right] {0.57} (2)
            edge [bend left=15] node[arrow label, below] {0.14} (0)
            edge [bend left=20] node[arrow label, right] {0.29} (1);
