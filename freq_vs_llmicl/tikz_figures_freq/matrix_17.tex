...
\begin{tikzpicture}[->, auto, thick, node distance=4cm, >=latex] 
    ...
    \path[->, very thick, >=latex, draw=black] 
        (0) edge [loop left, distance=1cm, out=200, in=225] node[arrow label, left] {0.62} (0)
            edge [bend left=20] node[arrow label, left] {0.12} (1)
        ...
        (1) edge [loop above, distance=1cm, out=75, in=100] node[arrow label, above] {0.00} (1)
            edge [bend left=20] node[arrow label, left] {0.67} (0)
            edge [bend left=20] node[arrow label, right] {0.33} (2)
        (2) edge [loop right, distance=1cm, out=-50, in=-25] node[arrow label, right] {0.67} (2)
            edge [bend left=15] node[arrow label, below] {0.17} (0)
            edge [bend left=20] node[arrow label, right] {0.17} (1);
